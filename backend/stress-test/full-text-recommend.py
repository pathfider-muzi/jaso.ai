...
# Set param datas
params = '{"spec": "인하대학교 / 컴퓨터공학과 / 3.98 / 토익 990 / IT/컴퓨터 교육 / 인턴 2회 / 정보처리기사", "listNum": 50}'
# Set cookie datas
...
class TestRunner:
	...
	def __call__(self):
		...
		result = request1.POST("http://34.64.92.197:3000/", params, headers)
